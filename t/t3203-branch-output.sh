...
test_expect_success 'git branch -v works with CRLF input' '
  ...
  crlf-two-line-subject-no-body                   8ca104a Subject first line Subject second line
  crlf-two-line-subject-no-body-trailing-newline  52360ed Subject first line Subject second line
  crlf-two-line-subject-no-body-trailing-newline2 9ff60d6 Subject first line Subject second line
* master                                          139b20d two
	EOF
	git branch -v >actual &&
	test_cmp expect actual
